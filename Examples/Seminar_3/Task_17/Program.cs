...
int getCoordinateFromUser(string userInformation)   //проверка интересная 
{
    int result = 0;
    while(result == 0)
    {
        ...
        int.TryParse(userLine, out result);     //на вход получаем строку, на выход интовый результат
